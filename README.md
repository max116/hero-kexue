...
22.6.27更新：目前新部署的项目成功后，heroku域名代理地址在中国大陆直连可能已被限制，显示该网页无法显示，翻墙后正常，大家只能使用反代方式啦

Github那边已出现大面积封杀heroku代理项目，大家在github做好隐藏工作哦。。

方案一：workers或者pages反代自定义域 （pages无须域名，workers须要域名）

方案二：workers或者pages反代CF http端口（workers与pages都无须域名）
